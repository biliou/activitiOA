...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/activiti/processDefinition/gotoProcessDefinitionImage">流程图</a></li>
	</ul>
		...
		<table id="processDefinitionListTable" class="table table-striped table-bordered table-condensed">
			...
			<c:forEach items="${processDefinitionList}" var="processDefinition">
				<tr>										 
					...
					<td><a href="${ctx}/activiti/processDefinition/gotoProcessDefinitionImage?deploymentId=${processDefinition.deploymentId}&imageName=${processDefinition.diagramResourceName}">流程图</a></td>
 				</tr>
			</c:forEach>
