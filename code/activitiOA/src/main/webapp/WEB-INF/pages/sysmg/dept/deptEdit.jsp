...
var setting = {
	...
	$(document).ready(function(){	
		 ...
		 var deptId  = $("#id").val(); 
	     $.get("${ctx}/sysmg/dept/getParentDeptTreeData?deptId="+deptId, function (zNodes) {           	
	        // 初始化树结构
			...
			submitHandler: function(form){
				...
				loading('正在提交，请稍等...');
					...
					success:function(data){//与服务器交互成功调用的回调函数
						...
						alert(data.result);
						//history.go(-1);
						window.location.href="${ctx}/sysmg/dept/gotoDeptList";
					}
				});
			},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysmg/dept/gotoDeptList">部门列表</a></li>
		<li class="active">
