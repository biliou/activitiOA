...
var setting = {
	...
	$(document).ready(function(){	
		 ...
		 var areaId  = $("#id").val(); 
	     $.get("${ctx}/sysmg/area/getParentAreaTreeData?areaId="+areaId, function (zNodes) {           	
	        // 初始化树结构
			...
			submitHandler: function(form){
				...
				loading('正在提交，请稍等...');
					...
					success:function(data){//与服务器交互成功调用的回调函数
						...
						alert(data.result);
						//history.go(-1);
						window.location.href="${ctx}/sysmg/area/gotoAreaList";
					}
				});
			},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysmg/area/gotoAreaList">区域列表</a></li>
		<li class="active">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div class="input-append">
					...
					<input id="parentName" name="parentName" readonly="readonly" type="text" value="${area.parentName}" style=""/>
