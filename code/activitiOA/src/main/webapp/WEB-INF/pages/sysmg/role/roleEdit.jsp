			...
			submitHandler: function(form){
				...
				loading('正在提交，请稍等...');
					...
					success:function(data){//与服务器交互成功调用的回调函数
						...
						alert(data.result);
						//history.go(-1);
						window.location.href="${ctx}/sysmg/role/gotoRoleList";
					}
				});
			},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysmg/role/gotoRoleList">角色列表</a></li>
		<li class="active"><a href="javascript:void(0);">角色 <c:choose>
	...
	<form id="roleEditForm" class="form-horizontal" action="#" method="post">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="name" name="name" class="required input-xlarge" type="text" value="${role.name}"
					maxlength="50" />
