	...
	<div id="main" style="width: auto;">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand">
					<span id="productName">OA系统</span>
				</div>
				<ul id="userControl" class="nav pull-right">

					<li id="userInfo" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
						href="#" title="个人信息">您好,系统超级管理员&nbsp;</a>
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space: nowrap; float: none;">
						<li class="menu"><a class="menu" href="javascript:" data-href="#" data-id="27"><span>我的面板</span></a>
						</li>
						<li class="menu active"><a class="menu" href="javascript:" data-href="#" data-id="2"><span>系统设置</span></a>
					</ul>
				</div>
				<!--/.nav-collapse -->
			</div>
			...
			<div id="content" class="row-fluid">
				<div id="left" style="width: 160px; height: 604px;">
					<div class="accordion" id="menu-27" style="display: none;">
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse" data-parent="#menu-27"
									data-href="#collapse-28" href="#collapse-28" title=""><i class="icon-chevron-down"></i>&nbsp;个人信息</a>
							</div>
							<div id="collapse-28" class="accordion-body in collapse" style="height: auto;">
								<div class="accordion-inner">
									<ul class="nav nav-list">
										<li class=""><a data-href=".menu3-29" href="${ctx}/sysmg/user/gotoUserInfo"
											target="mainFrame"><i class="icon-user"></i>&nbsp;个人信息</a>
											<ul class="nav nav-list hide" style="margin: 0; padding-right: 0;">
											</ul></li>
										<li class="active"><a data-href=".menu3-30" href="${ctx}/sysmg/user/gotoChangePwd"
											target="mainFrame"><i class="icon-lock icon-white"></i>&nbsp;修改密码</a>
											<ul class="nav nav-list hide" style="margin: 0; padding-right: 0;">
											</ul></li>
									</ul>
								</div>
					...
					<div class="accordion" id="menu-2">
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse" data-parent="#menu-2"
									data-href="#collapse-13" href="#collapse-13" title=""><i class="icon-chevron-down"></i>&nbsp;机构用户</a>
							</div>
							<div id="collapse-13" class="accordion-body in collapse" style="height: auto;">
								<div class="accordion-inner">
									<ul class="nav nav-list">
										<li class="active"><a data-href=".menu3-20" href="userMgr.html" target="mainFrame"><i
						...
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#menu-2"
									data-href="#collapse-3" href="#collapse-3" title=""><i class="icon-chevron-right"></i>&nbsp;系统设置</a>
							</div>
							<div id="collapse-3" class="accordion-body  collapse" style="height: 0px;">
								<div class="accordion-inner">
									<ul class="nav nav-list">
										...
										<li class=""><a data-href=".menu3-7" href="roleList.html" target="mainFrame"><i
												class="icon-lock"></i>&nbsp;角色管理</a>
											<ul class="nav nav-list hide" style="margin: 0; padding-right: 0;">
											</ul></li>
										<li class=""><a data-href=".menu3-10" href="${ctx}/sysmg/dict/gotoDictList"
											target="mainFrame"><i class="icon-th-list"></i>&nbsp;字典管理</a>
											<ul class="nav nav-list hide" style="margin: 0; padding-right: 0;">
											</ul></li>
									</ul>
								</div>
				...
				<div id="right" style="height: 604px; width: 1243px;">
					<iframe id="mainFrame" name="mainFrame" src="" style="overflow: visible; height: 604px;"
						scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
			</div>
			<div id="footer" class="row-fluid">
				Copyright © 2015-2015 <a href="http://www.tanzhouedu.com/" target="_blank">权限管理系统</a> - Powered
				By tz V1.0
			</div>
		</div>
	</div>
